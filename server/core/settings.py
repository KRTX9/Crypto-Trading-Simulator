...
MIDDLEWARE = [
    ...
    'core.middleware.AutoBotExecutorMiddleware',  # Automatic bot execution
...
# JWT Settings
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=config('JWT_ACCESS_TOKEN_LIFETIME_MINUTES', default=120, cast=int)),  # Increased to 2 hours
    'REFRESH_TOKEN_LIFETIME': timedelta(days=config('JWT_REFRESH_TOKEN_LIFETIME_DAYS', default=7, cast=int)),  # Increased to 7 days
